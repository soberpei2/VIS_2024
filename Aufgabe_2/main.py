...
list = iFR.parseText2blocksOfMbsObjects(test,"$",["RIGID_BODY","CONSTRAINT","FORCE_GenericForce","FORCE_GenericTorque","MEASURE"]) #force und mesasure kein actor programmiert
